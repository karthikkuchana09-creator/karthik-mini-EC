...
export default function CreateWorkflowModal({ isOpen, onClose, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null);
    try {
      await onSubmit({ ...form, trigger_event: form.trigger_event || null });
      setForm({ name: '', description: '', entity_type: 'TASK', trigger_event: '', status: 'active' });
      onClose();
    } catch (err) {
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Define a new workflow automation rule set</p>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Task Overdue Escalation"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Entity Type <span className="text-red-500">*</span></label>
              <select
