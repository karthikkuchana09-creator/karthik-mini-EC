...
export default function ChannelTasks() {
  ...
  const handleAssign = async (taskId, assignedToId) => {
    ...
    try {
      await channelTasksApi.assignChannelTask(channelId, taskId, assignedToId);
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <Breadcrumb
        ...
        items={[
          ...
          { label: channel?.name || 'Channel', to: `/channels/${channelId}` },
          { label: 'Tasks' },
        ]}
      />
      ...
      <div className="bg-white rounded-2xl border border-gray-200/70 shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          <DataTable
            ...
            emptyMessage="Create a task to get started with this channel."
            rowKey="id"
          />
        </div>
      )}
