  ...
  return (
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route path="/team-intelligence" element={<ProtectedRoute allowedRoles={['admin', 'manager']}><ErrorBoundary><Suspense fallback={<SkeletonPage />}><TeamIntelligence /></Suspense></ErrorBoundary></ProtectedRoute>} />
